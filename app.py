...
class UserInput(BaseModel):
    ...
    weight: Annotated[int, Field(..., gt=5, description='Weight of the user')]
...
@app.get('/')
def homepage():
    return {'message': '🏠 Welcome to the Insurance Premium Prediction API. Use POST /predict to get predictions.'}
